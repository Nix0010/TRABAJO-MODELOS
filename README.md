...
El objetivo principal es visualizar el proceso actual (AS-IS), identificar puntos críticos y cuellos de botella, y proponer mejoras orientadas a la eficiencia, la automatización y la experiencia del usuario (versión TO-BE). Además, se aplican elementos formales del modelado UML como swimlanes, decisiones, fork/join, eventos/señales y flujos de datos, con el fin de documentar el proceso de manera precisa y servir como base para futuras optimizaciones del sistema académico.
